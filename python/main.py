...
def execute_scenario(obstacles,scene, ASSETS=dict()):
    ...
    time_window    = 0.65                     # Time Frame over which the dynamic trajectories are predicted
    time_step      = time_window/6            # The time step. We sample 10 points per trajectory
    ta             = max_v/(2*time_window)    # Translational acceleration involved in calculating the velocity range
